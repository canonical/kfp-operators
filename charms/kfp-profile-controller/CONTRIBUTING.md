...
This document outlines the processes and practices recommended for contributing enhancements to `kfp-profile-controller`.
...
To build `kfp-profile-controller` run:
...
# Deploy the charm
juju deploy ./kfp-profile-controller_ubuntu@24.04-amd64.charm \
