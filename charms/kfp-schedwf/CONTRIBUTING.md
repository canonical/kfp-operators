...
This document outlines the processes and practices recommended for contributing enhancements to `kfp-schedwf`.
...
# Deploy the charm
juju deploy ./kfp-schedwf_ubuntu@24.04-amd64.charm \
