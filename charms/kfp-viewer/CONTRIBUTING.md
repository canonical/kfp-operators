...
This document outlines the processes and practices recommended for contributing enhancements to `kfp-viewer`.
...
# Deploy the charm
juju deploy ./kfp-viewer_ubuntu@24.04-amd64.charm \
    {{ --resource oci-image=$(yq '.resources."kfp-viewer-image"."upstream-source"' metadata.yaml) }}
