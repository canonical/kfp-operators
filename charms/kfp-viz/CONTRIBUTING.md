...
This document outlines the processes and practices recommended for contributing enhancements to `kfp-viz`.
...
# Deploy the charm
juju deploy ./kfp-viz_ubuntu@24.04-amd64.charm \
